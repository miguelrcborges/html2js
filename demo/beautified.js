...
const componentTwo = () => {
    ...
    e0.setAttribute('class', 'other-class');
...
const componentFour = (name) => {
    const e = document.createElement('div');
    e.setAttribute('id', 'componentFour');
    const e0 = document.createElement('h1');
    e0.textContent = `Some random test with "'\\\`.`;
    e.appendChild(e0);
    const e1 = document.createElement('p');
    e1.textContent = `Hello ${name}`;
    e.appendChild(e1);
    return e;
};
/**
